            ...
            $(document).ready(function () {
				...
				if ($('#aramex-actions-dropdown').length === 0) {
					var dropdown = '<div style="display: inline-block; position: relative; margin-left: 15px;" id="aramex-actions-dropdown">' +
						...
						'<li style="margin: 0;"><a id="create_aramex_shipment" style="display: block; padding: 10px 15px; text-decoration: none; color: #2271b1; cursor: pointer; border-bottom: 1px solid #f0f0f0; background: transparent;" onmouseover="this.style.background=\'#f6f7f7\'" onmouseout="this.style.background=\'transparent\'"><span class="dashicons dashicons-admin-page" style="vertical-align: middle; margin-right: 8px;"></span><?php echo esc_html__('Create Bulk Shipment', 'aramex'); ?></a></li>' +
						'<li style="margin: 0;"><a id="bulk_print_label" style="display: block; padding: 10px 15px; text-decoration: none; color: #2271b1; cursor: pointer; border-bottom: 1px solid #f0f0f0; background: transparent;" onmouseover="this.style.background=\'#f6f7f7\'" onmouseout="this.style.background=\'transparent\'"><span class="dashicons dashicons-printer" style="vertical-align: middle; margin-right: 8px;"></span><?php echo esc_html__('Print Bulk Labels', 'aramex'); ?></a></li>' +
						'<li style="margin: 0;"><a id="bulk_return_shipment" style="display: block; padding: 10px 15px; text-decoration: none; color: #2271b1; cursor: pointer; background: transparent;" onmouseover="this.style.background=\'#f6f7f7\'" onmouseout="this.style.background=\'transparent\'"><span class="dashicons dashicons-undo" style="vertical-align: middle; margin-right: 8px;"></span><?php echo esc_html__('Create Return Pickup', 'aramex'); ?></a></li>' +
						'</ul>' +
						'</div>';
